...
const { testConnection } = require('../backend/src/config/supabase');
...
const departmentsRoutes = require('../backend/src/routes/departments');
const assessmentsRoutes = require('../backend/src/routes/assessments');
