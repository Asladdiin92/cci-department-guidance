...
Students at the College of Computing and Informatics (CCI) at Haramaya University face challenges in selecting the most suitable department (Computer Science, Software Engineering, Information Technology, Information System, Information Science, Statistics) after completing their freshman year. 
...
4. **Create a department information repository** that:
   - Presents detailed profiles for all 6 CCI departments
...
- Department information pages (CS, SWE, IT, IS, ISC, Statistics)
...
1. **Department Head Interviews** (9 questions per department)
   ...
   - Targeting all 6 CCI departments
